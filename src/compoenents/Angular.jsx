...
const courseB=  [
    {     mainH:"Angular 6: The Big Picture",
              by:"by Mark Zamoyta",
              time:"3h 58m ",
              stars:4,
              review:"(1868)" },
    { mainH:"Angular: Getting Started",
    ...
    {  mainH:"Angular CLI",
            ...
            stars:5,
            review:"(335)" },
    {  mainH:"Styling Angular 12 Applications",
            by:"by Prateek Parekh",
            time:"48m",
            stars:4,
            review:"(259)" },
    {  mainH:"Styling Applications with Angular Material",
            by:"By : Prof ABC",
            time:"3h 58m",
            stars:4,
            review:"(1868)" },
    {  mainH:"Build an Album Store Product Page with Angular",
            by:"by Jeff Batt",
            time:"11 35m",
            stars:3,
            review:"(235)" },
        ...
        <HStack mt="20px">
            ...
            <VStack w="50%" marginLeft="5%"  marginTop="-60%">
                ...
                <VStack marginBottom="50px" >
                        ...
                        <Heading style={styles.mainH}>Angular</Heading>
                        ...
                        <Text style={styles.desc}>Angular is a complete JavaScript framework for creating dynamic and interactive applications in HTML.
                         Aside from being one of the hottest frameworks on the web, Angular is easy to learn yet powerful enough to help you develop complex single-page web applications. This path includes content covering Angular 2 and beyond. 
                        For the original version, see our AngularJS path.</Text>
                </VStack>
                        ...
                        <Text style={styles.subH2}>Courses in this path</Text>
                            <MenuButton  onClick={isOpenA? onCloseA: onOpenA}  style={styles.courseSelector} >
                                <Flex justifyContent={"space-between"} alignItems="center"> <Text> Beginner </Text> {isOpenA ? <ChevronUpIcon /> : <ChevronDownIcon />}</Flex>  
                            </MenuButton>
                        ...
                        <Text style={styles.subH2}></Text>
                            <MenuButton  onClick={isOpenB? onCloseB: onOpenB}  style={styles.courseSelector} >
                                <Flex justifyContent={"space-between"} alignItems="center"> <Text> Intermedte </Text> {isOpenB ? <ChevronUpIcon /> : <ChevronDownIcon />}</Flex>  
                            </MenuButton>
                            <MenuList  bg="black"  w="69%" border="none" >
                                <Text style={styles.by}>Dive into Angular while learning the basics of arrays, collections, and functions as well as advanced topics such as promises and asynchronous programming.</Text>
                                {courseB.map((el,i)=>(<Body key={i} heading={el.mainH} by={el.by} time={el.time} star={el.stars} review={el.review} />))}
                        ...
                        <Text style={styles.subH2}></Text>
                            <MenuButton  onClick={isOpenC? onCloseC: onOpenC}  style={styles.courseSelector} >
                                <Flex justifyContent={"space-between"} alignItems="center"> <Text> Advanced </Text> {isOpenC ? <ChevronUpIcon /> : <ChevronDownIcon />}</Flex>  
                            </MenuButton>
                            <MenuList  bg="black"  w="69%" border="none" >
                                <Text style={styles.by}>Dive into Angular while learning the basics of arrays, collections, and functions as well as advanced topics such as promises and asynchronous programming.</Text>
                                {courseB.map((el,i)=>(<Body key={i} heading={el.mainH} by={el.by} time={el.time} star={el.stars} review={el.review} />))}
            ...
            <VStack w="50%"  > 
                ...
                <VStack style={styles.rightCard}>
                    ...
                    <UnorderedList >
                            <ListItem>Angular core concepts</ListItem>
                            ...
                            <ListItem>Advanced workflows</ListItem>
                    </UnorderedList>
                    </VStack>
                    <Spacer />
                    ...
                    <VStack marginLeft="5%" textAlign="justify">
                    <Text style={styles.subH5}>This path is intended for beginners and no prerequisites are required.</Text>
                    </VStack>
                </VStack>
                <Spacer />
                ...
                <Wrap w="70%">
                    ...
                    <Box style={styles.tworows}>
                        <Text style={styles.tworows.text}>Front-end Developer</Text>
                    </Box>
                    ...
                    <Box style={styles.tworows}>
                        <Text style={styles.tworows.text}>JavaScript</Text>
                    </Box>

                    <Box style={styles.tworows}>
                        <Text style={styles.tworows.text}>React</Text>
                    </Box>

                    <Box style={styles.tworows}>
                        <Text style={styles.tworows.text}>HTML5</Text>
                    </Box>
                </Wrap>
